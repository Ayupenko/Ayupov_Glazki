...
namespace Ayupov_Glazki
{
    ...
    public partial class AyupovGlazkiEntities : DbContext
    {
        public AyupovGlazkiEntities()
            : base("name=AyupovGlazkiEntities")
        {
        }
        private static AyupovGlazkiEntities _context;
